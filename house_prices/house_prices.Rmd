...
for (item in colnames(train_quali)){
  frequencia_abs_variavel <- data.frame(table(train_quali[item]))[1]
  frequencia_abs_valor <- data.frame(table(train_quali[item]))[2]
  #print(frequencia_abs_variavel)
  freq_abs_train_quanti <-  data.frame(variavel = frequencia_abs_variavel,freq_abs= frequencia_abs_valor)
